...
// Import songs
import song1 from "../static/songs/Rockabye Song- Mp3.mp3";
import song2 from "../static/songs/rain-over-me-ft-marc-anthony.mp3";
import song3 from "../static/songs/danza-kuduro-remix-long-version.mp3";
import song4 from "../static/songs/Justin Bieber - Baby Ft Ludacris.mp3";
import song5 from "../static/songs/Wiz_Khalifa_Ft_Charlie_Puth_-_See_You_Again.mp3";

// Import song cover images
import song1Img from "../static/Rockabye.jpg";
import song2Img from "../static/Rain-over-me.jpeg";
import song3Img from "../static/Don omar.jpg";
import song4Img from "../static/Baby-justin.jpeg";
import song5Img from "../static/see_you_again.jpeg";
...
export default class App extends React.Component {
  constructor() {
    ...
    this.state = {
      ...
      songItems: [
        ...
        "Baby - Justin Bieber",
        "See_You_Again -Khalifa_Ft_Charlie",
      ],
  ...
  seekSongForward = (e) => {
    ...
    // Using Zing touch Lib for forwarding
